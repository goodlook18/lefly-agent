...
This matrix describes the `v0.1.1` source Alpha. `Tested` means the release gate runs that configuration. `Supported` means it is an intended public contract. Anything else is not claimed by this release.
...
| `lefly-protocol`     | `0.1.1` | Included as source                    |
| `lefly-sdk-python`   | `0.1.1` | Included as source                    |
| `lefly-simulator`    | `0.1.1` | Included as source                    |
| `@lefly/console-web` | `0.1.1` | Included as source and packaged build |
| `lefly-agent`        | `0.1.1` | Included as source                    |
...
| --- | --- | --- |
| Portable action assets and CSV playback | Planned | Built-in Simulator presets only; not included in `v0.1.1` |
...
| --- | --- | --- |
| Python clean core | CPython 3.12 in CI | Protocol, SDK, and Simulator metadata allows Python 3.9+; the v0.1.1 release support baseline is Python 3.12 |
